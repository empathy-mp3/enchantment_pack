function empathymp3:sanguine/cost2
function empathymp3:spells/berserk/clear
tag @a[limit=3,sort=nearest,distance=..8] add berserk
effect give @a[tag=berserk] minecraft:strength 10
effect give @a[tag=berserk] minecraft:speed 10 1
...
schedule function empathymp3:spells/berserk/clear 10s